import { ScoreCategory, DiceRoll } from '../types';
...
export class GameLogicService {
  ...
  static getScoreCategories(): ScoreCategory[] {
    return [
      { name: 'Ones', key: 'ones', calculate: this.calculateOnes, isUpper: true },
      { name: 'Twos', key: 'twos', calculate: this.calculateTwos, isUpper: true },
      { name: 'Threes', key: 'threes', calculate: this.calculateThrees, isUpper: true },
      { name: 'Fours', key: 'fours', calculate: this.calculateFours, isUpper: true },
      { name: 'Fives', key: 'fives', calculate: this.calculateFives, isUpper: true },
      { name: 'Sixes', key: 'sixes', calculate: this.calculateSixes, isUpper: true },
      { name: 'Three of a Kind', key: 'three_of_kind', calculate: this.calculateThreeOfKind, isUpper: false },
      { name: 'Four of a Kind', key: 'four_of_kind', calculate: this.calculateFourOfKind, isUpper: false },
      { name: 'Full House', key: 'full_house', calculate: this.calculateFullHouse, isUpper: false },
      { name: 'Small Straight', key: 'small_straight', calculate: this.calculateSmallStraight, isUpper: false },
      { name: 'Large Straight', key: 'large_straight', calculate: this.calculateLargeStraight, isUpper: false },
      { name: 'Kniffel', key: 'kniffel', calculate: this.calculateKniffel, isUpper: false },
      { name: 'Chance', key: 'chance', calculate: this.calculateChance, isUpper: false },
    ];
  }
  ...
  static rollDice(count: number = 5): number[] {
